...
## Test Account (Clerk dev environment)

| Field    | Value                          |
|----------|-------------------------------|
| Email    | `test+clerk_test@example.com` |
| Password | `Fractalist123!`              |

> This account uses Clerk's test email feature (`+clerk_test` suffix bypasses real email verification in development mode). OTP code if needed: `424242`.
